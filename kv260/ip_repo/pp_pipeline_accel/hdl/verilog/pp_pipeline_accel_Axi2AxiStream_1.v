...
reg   [63:0] gmem1_addr_read_reg_187;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln1024_reg_183_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (ldata1_full_n == 1'b0)) | ((icmp_ln1024_reg_183 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_gmem1_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln1024_reg_183_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (ldata1_full_n == 1'b0)) | ((icmp_ln1024_reg_183 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_gmem1_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln1024_reg_183_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (ldata1_full_n == 1'b0)) | ((icmp_ln1024_reg_183 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_gmem1_RVALID == 1'b0)));
end
...
always @ (*) begin
    ap_block_state73_pp0_stage0_iter1 = ((icmp_ln1024_reg_183 == 1'd0) & (m_axi_gmem1_RVALID == 1'b0));
end
...
assign i_V_2_fu_141_p2 = (i_V_reg_100 + 21'd1);

assign icmp_ln1024_fu_147_p2 = ((i_V_reg_100 == addrbound_V_read) ? 1'b1 : 1'b0);

assign icmp_ln878_fu_111_p2 = ((addrbound_V_read == 21'd0) ? 1'b1 : 1'b0);

assign ldata1_din = gmem1_addr_read_reg_187;

assign m_axi_gmem1_ARADDR = sext_ln1024_fu_127_p1;
