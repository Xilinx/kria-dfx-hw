...
wire   [10:0] Axi2Mat_entry6_U0_rows_out_din;
wire    Axi2Mat_entry6_U0_rows_out_write;
wire   [10:0] Axi2Mat_entry6_U0_cols_out_din;
wire    Axi2Mat_entry6_U0_cols_out_write;
wire   [31:0] Axi2Mat_entry6_U0_stride_out_din;
wire    Axi2Mat_entry6_U0_stride_out_write;
wire    Axi2Mat_entry18_U0_ap_start;
wire    Axi2Mat_entry18_U0_ap_done;
wire    Axi2Mat_entry18_U0_ap_continue;
wire    Axi2Mat_entry18_U0_ap_idle;
wire    Axi2Mat_entry18_U0_ap_ready;
wire    Axi2Mat_entry18_U0_start_out;
wire    Axi2Mat_entry18_U0_start_write;
wire    Axi2Mat_entry18_U0_din_read;
wire    Axi2Mat_entry18_U0_rows_read;
wire    Axi2Mat_entry18_U0_cols_read;
wire    Axi2Mat_entry18_U0_stride_read;
wire   [63:0] Axi2Mat_entry18_U0_din_out_din;
wire    Axi2Mat_entry18_U0_din_out_write;
wire   [10:0] Axi2Mat_entry18_U0_rows_out_din;
wire    Axi2Mat_entry18_U0_rows_out_write;
wire   [10:0] Axi2Mat_entry18_U0_cols_out_din;
wire    Axi2Mat_entry18_U0_cols_out_write;
wire   [31:0] Axi2Mat_entry18_U0_stride_out_din;
wire    Axi2Mat_entry18_U0_stride_out_write;
...
wire   [4:0] last_blk_pxl_width_U0_ret_out_din;
...
wire    Axi2Mat_Block_split35_proc_U0_stride_read;
wire    Axi2Mat_Block_split35_proc_U0_cols_read;
wire   [31:0] Axi2Mat_Block_split35_proc_U0_stride_out_din;
wire    Axi2Mat_Block_split35_proc_U0_stride_out_write;
wire   [10:0] Axi2Mat_Block_split35_proc_U0_cols_out_din;
wire    Axi2Mat_Block_split35_proc_U0_cols_out_write;
wire   [21:0] Axi2Mat_Block_split35_proc_U0_ap_return;
...
wire   [10:0] addrbound_1_U0_rows_out_din;
...
wire   [63:0] Axi2AxiStream_U0_ldata1_din;
...
wire   [15:0] AxiStream2MatStream_U0_imgInput_uv_467_din;
wire    AxiStream2MatStream_U0_imgInput_uv_467_write;
...
wire    AxiStream2MatStream_U0_stride_read;
...
wire   [4:0] last_blk_width_c_dout;
wire    last_blk_width_c_empty_n;
wire    stride_c16_full_n;
wire   [31:0] stride_c16_dout;
wire    stride_c16_empty_n;
wire    cols_c17_full_n;
wire   [10:0] cols_c17_dout;
wire    cols_c17_empty_n;
wire   [21:0] cols_tmp_loc_channel_dout;
wire    cols_tmp_loc_channel_empty_n;
wire   [19:0] p_channel_dout;
wire    p_channel_empty_n;
wire    rows_c18_full_n;
wire   [10:0] rows_c18_dout;
...
wire   [0:0] start_for_Axi2Mat_entry18_U0_din;
wire    start_for_Axi2Mat_entry18_U0_full_n;
wire   [0:0] start_for_Axi2Mat_entry18_U0_dout;
wire    start_for_Axi2Mat_entry18_U0_empty_n;
wire   [0:0] start_for_Axi2Mat_Block_split35_proc_U0_din;
wire    start_for_Axi2Mat_Block_split35_proc_U0_full_n;
wire   [0:0] start_for_Axi2Mat_Block_split35_proc_U0_dout;
wire    start_for_Axi2Mat_Block_split35_proc_U0_empty_n;
...
wire    Axi2Mat_Block_split35_proc_U0_start_full_n;
wire    Axi2Mat_Block_split35_proc_U0_start_write;
...
pp_pipeline_accel_Axi2Mat_entry6 Axi2Mat_entry6_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pp_pipeline_accel_Axi2Mat_entry18 Axi2Mat_entry18_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pp_pipeline_accel_Axi2Mat_Block_split35_proc Axi2Mat_Block_split35_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pp_pipeline_accel_addrbound_1 addrbound_1_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pp_pipeline_accel_Axi2Mat_Block_split37_proc Axi2Mat_Block_split37_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pp_pipeline_accel_AxiStream2MatStream AxiStream2MatStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pp_pipeline_accel_fifo_w64_d2_S_x din_c1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pp_pipeline_accel_fifo_w11_d2_S rows_c2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pp_pipeline_accel_fifo_w11_d2_S cols_c3_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pp_pipeline_accel_fifo_w32_d2_S_x stride_c4_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pp_pipeline_accel_fifo_w64_d5_S_x din_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pp_pipeline_accel_fifo_w32_d2_S_x stride_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pp_pipeline_accel_fifo_w5_d7_S last_blk_width_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pp_pipeline_accel_fifo_w32_d5_S_x stride_c16_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pp_pipeline_accel_fifo_w11_d5_S cols_c17_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pp_pipeline_accel_fifo_w22_d2_S cols_tmp_loc_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pp_pipeline_accel_fifo_w20_d2_S p_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pp_pipeline_accel_fifo_w11_d4_S rows_c18_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pp_pipeline_accel_fifo_w20_d2_S axibound_V_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pp_pipeline_accel_start_for_Axi2Mat_entry18_U0 start_for_Axi2Mat_entry18_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pp_pipeline_accel_start_for_Axi2Mat_Block_split35_proc_U0 start_for_Axi2Mat_Block_split35_proc_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pp_pipeline_accel_start_for_AxiStream2MatStream_U0 start_for_AxiStream2MatStream_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign Axi2Mat_Block_split35_proc_U0_ap_continue = cols_tmp_loc_channel_full_n;

assign Axi2Mat_Block_split35_proc_U0_ap_start = start_for_Axi2Mat_Block_split35_proc_U0_empty_n;

assign Axi2Mat_Block_split35_proc_U0_start_full_n = 1'b1;

assign Axi2Mat_Block_split35_proc_U0_start_write = 1'b0;
...
assign Axi2Mat_entry18_U0_ap_continue = 1'b1;

assign Axi2Mat_entry18_U0_ap_start = start_for_Axi2Mat_entry18_U0_empty_n;
...
assign addrbound_1_U0_ap_start = cols_tmp_loc_channel_empty_n;
...
assign ap_channel_done_cols_tmp_loc_channel = Axi2Mat_Block_split35_proc_U0_ap_done;

assign ap_channel_done_p_channel = addrbound_1_U0_ap_done;

assign ap_done = AxiStream2MatStream_U0_ap_done;

assign ap_idle = (last_blk_pxl_width_U0_ap_idle & (axibound_V_empty_n ^ 1'b1) & (p_channel_empty_n ^ 1'b1) & (cols_tmp_loc_channel_empty_n ^ 1'b1) & addrbound_1_U0_ap_idle & AxiStream2MatStream_U0_ap_idle & Axi2Mat_entry6_U0_ap_idle & Axi2Mat_entry18_U0_ap_idle & Axi2Mat_Block_split37_proc_U0_ap_idle & Axi2Mat_Block_split35_proc_U0_ap_idle & Axi2AxiStream_U0_ap_idle);
...
assign ap_sync_ready = (ap_sync_last_blk_pxl_width_U0_ap_ready & ap_sync_Axi2Mat_entry6_U0_ap_ready & ap_sync_Axi2AxiStream_U0_ap_ready);

assign imgInput_uv_467_din = AxiStream2MatStream_U0_imgInput_uv_467_din;

assign imgInput_uv_467_write = AxiStream2MatStream_U0_imgInput_uv_467_write;
...
assign start_for_Axi2Mat_Block_split35_proc_U0_din = 1'b1;

assign start_for_Axi2Mat_entry18_U0_din = 1'b1;
