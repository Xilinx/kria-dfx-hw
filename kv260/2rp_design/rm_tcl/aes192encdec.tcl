...
proc cr_bd_AES192 { parentCell designName} {
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  user.org:user:AES192_Dec:*\
  user.org:user:AES192_Enc:*\
  ...
  # Create ports
  set clk [ create_bd_port -dir I -type clk -freq_hz 299997000 clk ]
  set_property -dict [ list \
  ...
  set AES192_Dec_0 [ create_bd_cell -type ip -vlnv user.org:user:AES192_Dec AES192_Dec_0 ]

  # Create instance: AES192_Enc_0, and set properties
  set AES192_Enc_0 [ create_bd_cell -type ip -vlnv user.org:user:AES192_Enc AES192_Enc_0 ]
  ...
  connect_bd_net -net AES192_Dec_0_ap_done [get_bd_pins AES192_Dec_0/ap_done] [get_bd_pins axis_accel_sel_0/ap_done_enc]
  connect_bd_net -net AES192_Enc_0_ap_done [get_bd_pins AES192_Enc_0/ap_done] [get_bd_pins axis_accel_sel_0/ap_done_dec]
  ...
  connect_bd_net -net axis_accel_sel_0_ap_start_dec [get_bd_pins AES192_Enc_0/ap_start] [get_bd_pins axis_accel_sel_0/ap_start_dec]
  connect_bd_net -net axis_accel_sel_0_ap_start_enc [get_bd_pins AES192_Dec_0/ap_start] [get_bd_pins axis_accel_sel_0/ap_start_enc]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins AES192_Dec_0/ap_clk] [get_bd_pins AES192_Enc_0/ap_clk] [get_bd_pins AccelConfig_0/clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axis_accel_sel_0/ap_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins rm_comm_box_0/clk]
