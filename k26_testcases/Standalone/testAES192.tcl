...
fpga -no-revision-check -file ${AES192_0}
fpga -no-revision-check -file ${AES192_1}
...
dow -data -force ${AES192_IN_DATA}  0x02000000
dow -data -force ${AES192_OUT_DATA} 0x04000000
