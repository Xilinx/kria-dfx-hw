...
fpga -no-revision-check -file ${AES128_0}
fpga -no-revision-check -file ${AES128_1}
...
dow -data -force ${AES128_IN_DATA}  0x02000000
dow -data -force ${AES128_OUT_DATA} 0x04000000
