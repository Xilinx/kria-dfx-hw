...
# Proc to create BD AES128
proc cr_bd_AES128 { parentCell designName } {
  ...
  connect_bd_net -net AES128Dec_0_ap_idle [get_bd_pins AES128Dec_0/ap_idle] [get_bd_pins axis_accel_sel_0/ap_idle_dec]
  connect_bd_net -net AES128Dec_0_ap_ready [get_bd_pins AES128Dec_0/ap_ready] [get_bd_pins axis_accel_sel_0/ap_ready_dec]
  connect_bd_net -net AES128Enc_0_ap_done [get_bd_pins AES128Enc_0/ap_done] [get_bd_pins axis_accel_sel_0/ap_done_enc]
  connect_bd_net -net AES128Enc_0_ap_idle [get_bd_pins AES128Enc_0/ap_idle] [get_bd_pins axis_accel_sel_0/ap_idle_enc]
  connect_bd_net -net AES128Enc_0_ap_ready [get_bd_pins AES128Enc_0/ap_ready] [get_bd_pins axis_accel_sel_0/ap_ready_enc]
  connect_bd_net -net AccelConfig_0_ap_start [get_bd_pins AccelConfig_0/ap_start] [get_bd_pins axis_accel_sel_0/ap_start]
  connect_bd_net -net AccelConfig_0_config_port1_tdata [get_bd_pins AES128Dec_0/key] [get_bd_pins AES128Enc_0/key] [get_bd_pins AccelConfig_0/scalar1]
