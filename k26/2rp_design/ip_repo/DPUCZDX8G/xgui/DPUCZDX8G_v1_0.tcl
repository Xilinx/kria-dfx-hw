...
proc update_PARAM_VALUE.ALU_PARALLEL { PARAM_VALUE.ALU_PARALLEL } {
...
proc update_PARAM_VALUE.AWRLEN_BW { PARAM_VALUE.AWRLEN_BW } {
...
proc update_PARAM_VALUE.AWRLOCK_BW { PARAM_VALUE.AWRLOCK_BW } {
...
proc update_PARAM_VALUE.SIZE_REGMAP_SIZE { PARAM_VALUE.SIZE_REGMAP_SIZE } {
	# Procedure called to update SIZE_REGMAP_SIZE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SIZE_REGMAP_SIZE { PARAM_VALUE.SIZE_REGMAP_SIZE } {
	# Procedure called to validate SIZE_REGMAP_SIZE
	return true
}
...
proc update_MODELPARAM_VALUE.SIZE_REGMAP_SIZE { MODELPARAM_VALUE.SIZE_REGMAP_SIZE PARAM_VALUE.SIZE_REGMAP_SIZE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SIZE_REGMAP_SIZE}] ${MODELPARAM_VALUE.SIZE_REGMAP_SIZE}
}
