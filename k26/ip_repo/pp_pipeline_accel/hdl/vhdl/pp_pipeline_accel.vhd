...
architecture behav of pp_pipeline_accel is 
    ...
    "pp_pipeline_accel_pp_pipeline_accel,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xck26-sfvc784-2LVI-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.300000,HLS_SYN_LAT=8315770,HLS_SYN_TPT=8315765,HLS_SYN_MEM=22,HLS_SYN_DSP=0,HLS_SYN_FF=15075,HLS_SYN_LUT=27468,HLS_VERSION=2022_1}";
