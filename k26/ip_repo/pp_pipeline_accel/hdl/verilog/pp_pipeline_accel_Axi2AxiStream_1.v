...
reg   [15:0] cols_int16_reg_342;
wire   [0:0] icmp_ln1021_fu_156_p2;
reg   [0:0] icmp_ln1021_reg_347;
wire   [31:0] zext_ln232_fu_167_p1;
wire    ap_CS_fsm_state2;
wire    ap_CS_fsm_state4;
wire   [20:0] cols_addrbound_fu_195_p4;
reg   [20:0] cols_addrbound_reg_378;
wire   [0:0] cmp_i82_i_fu_239_p2;
reg   [0:0] cmp_i82_i_reg_383;
wire   [51:0] zext_ln1028_fu_245_p1;
reg   [51:0] zext_ln1028_reg_387;
wire   [31:0] zext_ln1028_1_fu_249_p1;
reg   [31:0] zext_ln1028_1_reg_392;
wire   [30:0] r_2_fu_265_p2;
reg   [30:0] r_2_reg_400;
wire    ap_CS_fsm_state5;
reg   [60:0] trunc_ln_reg_405;
wire   [0:0] icmp_ln1024_fu_260_p2;
...
wire  signed [63:0] sext_ln1028_fu_307_p1;
reg   [30:0] r_fu_102;
reg    ap_block_state77_on_subcall_done;
reg    ap_block_state1;
wire   [31:0] trunc_ln1540_fu_178_p0;
wire  signed [31:0] grp_fu_321_p2;
wire   [23:0] trunc_ln1540_fu_178_p1;
wire   [26:0] ret_V_fu_181_p3;
wire   [26:0] add_ln587_fu_189_p2;
wire   [31:0] trunc_ln1540_2_fu_205_p0;
wire  signed [31:0] grp_fu_328_p2;
wire   [23:0] trunc_ln1540_2_fu_205_p1;
wire   [26:0] ret_V_31_fu_208_p3;
wire   [26:0] add_ln587_1_fu_216_p2;
wire   [20:0] stride_addrbound_fu_222_p4;
wire   [20:0] addrbound_V_fu_232_p3;
wire   [31:0] zext_ln1024_fu_256_p1;
wire   [30:0] empty_fu_275_p0;
wire   [20:0] empty_fu_275_p1;
wire   [51:0] empty_fu_275_p2;
wire   [54:0] tmp_s_fu_280_p3;
wire   [63:0] p_cast1_i_fu_288_p1;
wire   [63:0] empty_226_fu_292_p2;
wire   [15:0] grp_fu_321_p0;
wire   [15:0] grp_fu_321_p1;
wire   [15:0] grp_fu_328_p0;
wire   [15:0] grp_fu_328_p1;
reg   [76:0] ap_NS_fsm;
...
wire   [51:0] empty_fu_275_p00;
wire   [31:0] grp_fu_321_p00;
wire   [31:0] grp_fu_328_p00;
wire    ap_ce_reg;
...
pp_pipeline_accel_mul_31ns_21ns_52_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 31 ),
    .din1_WIDTH( 21 ),
    .dout_WIDTH( 52 ))
mul_31ns_21ns_52_1_1_U18(
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((icmp_ln1024_fu_260_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        cols_addrbound_reg_378 <= {{add_ln587_fu_189_p2[26:6]}};
        zext_ln1028_1_reg_392[20 : 0] <= zext_ln1028_1_fu_249_p1[20 : 0];
        zext_ln1028_reg_387[20 : 0] <= zext_ln1028_fu_245_p1[20 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln1024_fu_260_p2 == 1'd1) & (cmp_i82_i_reg_383 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        trunc_ln_reg_405 <= {{empty_226_fu_292_p2[63:3]}};
    end
end
...
always @ (*) begin
    if (((icmp_ln1024_fu_260_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((cmp_i82_i_reg_383 == 1'd0) & (1'b1 == ap_CS_fsm_state77))) begin
        ldata_write = grp_Axi2AxiStream_1_Pipeline_VITIS_LOOP_1028_1_fu_142_ldata_write;
    end else begin
        ldata_write = 1'b0;
    end
...
always @ (*) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state76) | ((cmp_i82_i_reg_383 == 1'd0) & (1'b1 == ap_CS_fsm_state77)))) begin
        m_axi_gmem1_ARADDR = grp_Axi2AxiStream_1_Pipeline_VITIS_LOOP_1028_1_fu_142_m_axi_gmem1_ARADDR;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state76) | ((cmp_i82_i_reg_383 == 1'd0) & (1'b1 == ap_CS_fsm_state77)))) begin
        m_axi_gmem1_ARBURST = grp_Axi2AxiStream_1_Pipeline_VITIS_LOOP_1028_1_fu_142_m_axi_gmem1_ARBURST;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state5 : begin
            if (((icmp_ln1024_fu_260_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if (((icmp_ln1024_fu_260_p2 == 1'd1) & (cmp_i82_i_reg_383 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
...
assign add_ln587_1_fu_216_p2 = (ret_V_31_fu_208_p3 + 27'd63);

assign add_ln587_fu_189_p2 = (ret_V_fu_181_p3 + 27'd63);

assign addrbound_V_fu_232_p3 = ((icmp_ln1021_reg_347[0:0] == 1'b1) ? cols_addrbound_fu_195_p4 : stride_addrbound_fu_222_p4);
...
always @ (*) begin
    ap_block_state77_on_subcall_done = ((grp_Axi2AxiStream_1_Pipeline_VITIS_LOOP_1028_1_fu_142_ap_done == 1'b0) & (cmp_i82_i_reg_383 == 1'd0));
end

assign cmp_i82_i_fu_239_p2 = ((cols_addrbound_fu_195_p4 == 21'd0) ? 1'b1 : 1'b0);

assign cols_addrbound_fu_195_p4 = {{add_ln587_fu_189_p2[26:6]}};

assign cols_int16_fu_152_p1 = stride[15:0];

assign empty_226_fu_292_p2 = (p_cast1_i_fu_288_p1 + din);

assign empty_fu_275_p0 = empty_fu_275_p00;

assign empty_fu_275_p00 = r_fu_102;

assign empty_fu_275_p1 = zext_ln1028_reg_387;
...
assign grp_fu_321_p00 = p_read2;

assign grp_fu_321_p1 = zext_ln232_fu_167_p1;

assign grp_fu_328_p0 = grp_fu_328_p00;

assign grp_fu_328_p00 = cols_int16_reg_342;

assign grp_fu_328_p1 = zext_ln232_fu_167_p1;

assign icmp_ln1021_fu_156_p2 = ((stride == 32'd4294967295) ? 1'b1 : 1'b0);

assign icmp_ln1024_fu_260_p2 = (($signed(zext_ln1024_fu_256_p1) < $signed(p_read1)) ? 1'b1 : 1'b0);
...
assign p_cast1_i_fu_288_p1 = tmp_s_fu_280_p3;

assign r_2_fu_265_p2 = (r_fu_102 + 31'd1);

assign ret_V_31_fu_208_p3 = {{trunc_ln1540_2_fu_205_p1}, {3'd0}};

assign ret_V_fu_181_p3 = {{trunc_ln1540_fu_178_p1}, {3'd0}};

assign sext_ln1028_fu_307_p1 = $signed(trunc_ln_reg_405);

assign stride_addrbound_fu_222_p4 = {{add_ln587_1_fu_216_p2[26:6]}};

assign tmp_s_fu_280_p3 = {{empty_fu_275_p2}, {3'd0}};

assign trunc_ln1540_2_fu_205_p0 = grp_fu_328_p2;

assign trunc_ln1540_2_fu_205_p1 = trunc_ln1540_2_fu_205_p0[23:0];

assign trunc_ln1540_fu_178_p0 = grp_fu_321_p2;

assign trunc_ln1540_fu_178_p1 = trunc_ln1540_fu_178_p0[23:0];

assign zext_ln1024_fu_256_p1 = r_fu_102;

assign zext_ln1028_1_fu_249_p1 = cols_addrbound_fu_195_p4;

assign zext_ln1028_fu_245_p1 = addrbound_V_fu_232_p3;

assign zext_ln232_fu_167_p1 = p_read;

always @ (posedge ap_clk) begin
    zext_ln1028_reg_387[51:21] <= 31'b0000000000000000000000000000000;
    zext_ln1028_1_reg_392[31:21] <= 11'b00000000000;
end
