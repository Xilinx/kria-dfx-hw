...
proc create_hier_cell_dfx_slot_manager { parentCell nameHier } {
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins clk] [get_bd_pins rp0_decouple_status_sync/clk] [get_bd_pins siha_manager_0/clk]
...
proc create_hier_cell_clk_reset_gen { parentCell nameHier } {
  ...
  connect_bd_net -net xlconstant_vcc_dout [get_bd_pins ShellClkLocked] [get_bd_pins rp0ClkLocked] [get_bd_pins xlconstant_vcc/dout]
