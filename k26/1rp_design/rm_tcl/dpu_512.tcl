...
proc cr_bd_DPU_512 { parentCell designName} {
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_ports M_AXI_GMEM] [get_bd_intf_pins rm_comm_box_0/m_axi_gmem]
  ...
  connect_bd_net -net clk_2 [get_bd_ports clk] [get_bd_pins DPUCZDX8G_1/aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins rm_comm_box_0/clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins smartconnect_1/aclk1]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins DPUCZDX8G_1/aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins rm_comm_box_0/resetn]
  ...
  assign_bd_address -offset 0x008000000000 -range 0x008000000000 -target_address_space [get_bd_addr_spaces DPUCZDX8G_1/M_AXI_HP2] [get_bd_addr_segs rm_comm_box_0/s_axi_accel/reg0] -force
